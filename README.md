...
## <span style='background-color: #ffdce0'>문과</span><span style='background-color: #dcffe4'>이과</span> 팀 소개

| 팀원 | <span style='background-color: #dcffe4'>이</span>정우 | <span style='background-color: #dcffe4'>이</span>시우 | <span style='background-color: #ffdce0'>문</span>현수 | <span style='background-color: #ffdce0'>문</span>대현 |
| :--: | :---------------------------------------------------: | :---------------------------------------------------: | :---------------------------------------------------: | :---------------------------------------------------: |
